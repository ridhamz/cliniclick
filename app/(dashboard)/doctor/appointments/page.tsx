  ...
  <div className="mt-4 space-y-3">
    ...
    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <h4 className="text-sm font-semibold text-blue-900 mb-1">Notes du patient</h4>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1">
              <h4 className="text-sm font-semibold text-purple-900">Analyse IA</h4>
              <span className="px-2 py-0.5 bg-purple-200 text-purple-800 text-xs font-medium rounded-full">
                Recommandations
              </span>
            </div>
            <p className="text-sm text-purple-800 leading-relaxed">{appointment.ai}</p>
          </div>
        </div>
      </div>
    )}
